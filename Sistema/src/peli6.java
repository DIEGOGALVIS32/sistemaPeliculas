...
public class peli6 extends javax.swing.JFrame {

    public peli6() {
        initComponents();
        this.setLocationRelativeTo(null);
        rsscalelabel.RSScaleLabel.setScaleLabel(ftGreen, "src/canciondeamor.jpg");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cancion de amor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.BROWSE)) {
                try {
                    java.net.URI uri = new java.net.URI("https://cuevana3.ai/42912/country-at-heart");
                    desktop.browse(uri);
                } catch (Exception e) {
