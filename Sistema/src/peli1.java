...
public class peli1 extends javax.swing.JFrame {
    ...
    public peli1() {
        ...
        rsscalelabel.RSScaleLabel.setScaleLabel(ftGreen, "src/halloween.jpg");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Halloween final");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.BROWSE)) {
                try {
                    java.net.URI uri = new java.net.URI("https://cuevana3.ai/63486/halloween-ends");
                    desktop.browse(uri);
                } catch (Exception e) {
