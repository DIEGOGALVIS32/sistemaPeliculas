...
public class peli9 extends javax.swing.JFrame {

    public peli9() {
        initComponents();
        this.setLocationRelativeTo(null);
        rsscalelabel.RSScaleLabel.setScaleLabel(ftGreen, "src/mejorfan.jpg");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.BROWSE)) {
                try {
                    java.net.URI uri = new java.net.URI("https://cuevana3.ai/63387/jadore-ce-que-vous-faites");
                    desktop.browse(uri);
                } catch (Exception e) {
