...
public class peli8 extends javax.swing.JFrame {

    public peli8() {
        initComponents();
        this.setLocationRelativeTo(null);
        rsscalelabel.RSScaleLabel.setScaleLabel(ftGreen, "src/nochesex.jpg");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.BROWSE)) {
                try {
                    java.net.URI uri = new java.net.URI("https://cuevana3.ai/63230/30-noches-con-mi-ex");
                    desktop.browse(uri);
                } catch (Exception e) {
