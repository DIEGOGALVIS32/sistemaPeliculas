...
public class peli7 extends javax.swing.JFrame {

    public peli7() {
        initComponents();
        this.setLocationRelativeTo(null);
        rsscalelabel.RSScaleLabel.setScaleLabel(ftGreen, "src/masalla.jpg");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.BROWSE)) {
                try {
                    java.net.URI uri = new java.net.URI("https://cuevana3.ai/64091/depois-do-universo");
                    desktop.browse(uri);
                } catch (Exception e) {
